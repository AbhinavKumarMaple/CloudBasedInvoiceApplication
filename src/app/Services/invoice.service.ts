...
export class InvoiceService {
  ...
  getAllByEmp(
    ...
    if (userName && userName?.length > 1) {
      return this.http.get(
        `${this.baseUrl}/invoice/allemployeeinvoice?page=${page}&limit=${limit}&username=${userName}`,
        { params: params, observe: 'response', withCredentials: true }
      );
    } else {
      return this.http.get(
        `${this.baseUrl}/invoice/allemployeeinvoice?page=${page}&limit=${limit}`,
        { params: params, observe: 'response', withCredentials: true }
      );
    }
  }
  ...
  getAllByAccountant(
    ...
    if (userName && userName?.length > 1) {
      return this.http.get(
        `${this.baseUrl}/invoice/allInvoice?page=${page}&limit=${limit}&username=${userName}`,
        { params: params, observe: 'response', withCredentials: true }
      );
    } else {
      return this.http.get(
  ...
  updateById(id: any, data: any): Observable<any> {
    return this.http.put(`${this.baseUrl}/invoice/${id}`, data, {
      observe: 'response',
      withCredentials: true,
    });
  }
  ...
  getGeneratedInvoice(
    ...
    if (userName && userName?.length > 1) {
      return this.http.get(
        `${this.baseUrl}/generatedinvoice?page=${page}&limit=${limit}&username=${userName}`,
        { params: params, observe: 'response', withCredentials: true }
      );
    } else {
      return this.http.get(
        `${this.baseUrl}/generatedinvoice?page=${page}&limit=${limit}`,
        { params: params, observe: 'response', withCredentials: true }
      );
    }
  }
  ...
  updateGeneratedInvoiceById(id: any, data: any): Observable<any> {
    return this.http.put(`${this.baseUrl}/generatedinvoice/${id}`, data, {
      observe: 'response',
      withCredentials: true,
    });
  }
  deleteGeneratedInvoice(id: any): Observable<any> {
    return this.http.delete(`${this.baseUrl}/generatedinvoice/${id}`, {
      observe: 'response',
      withCredentials: true,
    });
  }
